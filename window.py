...
def movement_values():
    ...
    movement_frame=Frame(Canvas1,bg="white",relief=RAISED,bd=2)
    movement_frame.place(x=10,y=35,width=1300,height=650)

    f11=Frame(movement_frame,bg="white",relief=RAISED,bd=2)
    f11.grid(row=1,column=0,columnspan=3,ipadx=200)
    l1f1=Label(f11,text="Perticulars",font=("times new roman",12,"bold"),bg="white",fg="black",width=33,height=7)
    l1f1.pack(fill=X)
    f12=Frame(movement_frame,bg="white",relief=RAISED,bd=2)
    f12.place(x=710,y=0,width=580,height=80)
    l1f2=Label(f12,text="PRODUCT NAME",font=("times new roman",9,"bold"),bg="white",fg="black",borderwidth=5)
    l1f2.place(x=305,y=10,anchor="center")
    l1f3=Label(f12,text="C NAME",font=("times new roman",9,"bold"),bg="white",fg="black")
    l1f3.place(x=305,y=30,anchor="center")
    ...
    f13.place(x=0,y=150,width=710,height=450)
    ...
    f13bt3=Button(f13,text="C-name",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0,command=item_values)
    f13bt3.place(x=20,y=60,anchor="nw")
    f13bt4=Button(f13,text="Movement outwards",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    f13bt4.place(x=0,y=130,anchor="nw")
    f13bt5=Button(f13,text="Buyers",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    f13bt5.place(x=10,y=160,anchor="nw")
    f13bt6=Button(f13,text="C-name",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    f13bt6.place(x=20,y=190,anchor="nw")




    f14=Frame(movement_frame,bg="white",relief=RAISED,bd=1)
    f14.place(x=710,y=83,width=580,height=58)
    l1f5=Label(f14,text="Movement values",font=("times new roman",9,"bold"),bg="white",fg="black",borderwidth=5)
    l1f5.place(x=0,y=0,anchor="nw")
    l1f6=Label(f14,text="Quantity",font=("times new roman",9,"bold"),bg="white",fg="black",borderwidth=0)
    l1f6.place(x=0,y=30,anchor="nw")
    l1f7=Label(f14,text="Basic Rate",font=("times new roman",9,"bold"),bg="white",fg="black",borderwidth=0)
    l1f7.place(x=150,y=30,anchor="nw")
    l1f8=Label(f14,text="Effective rate",font=("times new roman",9,"bold"),bg="white",fg="black",borderwidth=0)
    l1f8.place(x=260,y=30,anchor="nw")
    l1f9=Label(f14,text="Values",font=("times new roman",9,"bold"),bg="white",fg="black",borderwidth=0)
    l1f9.place(x=320,y=30,anchor="nw")

    f15=Frame(movement_frame,bg="white",relief=RAISED,bd=1)
    f15.place(x=710,y=150,width=580,height=450)

    l4f6=Label(f15,text="10 Nos",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f6.place(x=0,y=60,anchor="nw")
    l4f8=Label(f15,text="10",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f8.place(x=150,y=60,anchor="nw")
    l4f7=Label(f15,text="10",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f7.place(x=260,y=60,anchor="nw")
    l4f8=Label(f15,text="100",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f8.place(x=320,y=60,anchor="nw")
    
    horizontal =Frame(f15, bg='black', height=1,width=360)
    horizontal.place(x=0, y=98)
    horizontal =Frame(f15, bg='black', height=1,width=360)
    horizontal.place(x=0, y=122)

    l4f6=Label(f15,text="10 Nos",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f6.place(x=0,y=100,anchor="nw")
    l4f8=Label(f15,text="10",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f8.place(x=150,y=100,anchor="nw")
    l4f7=Label(f15,text="10",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f7.place(x=260,y=100,anchor="nw")
    l4f8=Label(f15,text="100",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f8.place(x=320,y=100,anchor="nw")

    l4f6=Label(f15,text="10 Nos",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f6.place(x=0,y=190,anchor="nw")
    l4f8=Label(f15,text="10",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f8.place(x=150,y=190,anchor="nw")
    l4f7=Label(f15,text="10",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f7.place(x=260,y=190,anchor="nw")
    l4f8=Label(f15,text="100",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f8.place(x=320,y=190,anchor="nw")

    l4f6=Label(f15,text="10 Nos",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f6.place(x=0,y=210,anchor="nw")
    l4f8=Label(f15,text="10",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f8.place(x=150,y=210,anchor="nw")
    l4f7=Label(f15,text="10",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f7.place(x=260,y=210,anchor="nw")
    l4f8=Label(f15,text="100",font=("times new roman",12,"bold"),bg="white",fg="black",borderwidth=0)
    l4f8.place(x=320,y=210,anchor="nw")

    horizontal =Frame(f15, bg='black', height=1,width=360)
    horizontal.place(x=0, y=210)
    horizontal =Frame(f15, bg='black', height=1,width=360)
    horizontal.place(x=0, y=230)
